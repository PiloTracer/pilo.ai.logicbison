...
# Project-owned deliverables that live at repo root, not under .ai/ or .work/:
# generated by @plan-foundation (standards/) and cached by implementation work
# (docs/integration/). Always local in both fat- and thin-client modes.
mkdir -p "${REPO_ROOT}/standards"
touch "${REPO_ROOT}/standards/.gitkeep"
mkdir -p "${REPO_ROOT}/docs/integration"
touch "${REPO_ROOT}/docs/integration/.gitkeep"
...
echo "  2. Run @plan-foundation greenfield (generates this project's own ${REPO_ROOT}/standards/*.md — CONVENTIONS, FEATURE_STANDARD, DIRECTORY_MAP, etc. — plus foundation docs 01–04)"
