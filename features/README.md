...
Binding **rules** for SPECs remain in project-root `standards/*FEATURE_STANDARD*` (generated by `@plan-foundation greenfield`). **Artifacts** (SPEC files, amendments, changelogs) live under `.work/features/`.
