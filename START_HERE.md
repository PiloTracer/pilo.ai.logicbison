...
| Connect agents to tools-project API? | `@project-query-setup install` (guided: API key → MCP register → test). After setup: `@project-query-setup status` to check connectivity. |
