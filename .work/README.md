...
| `.work/standards/` | Project-owned binding engineering standards (generated by `@plan-foundation`) |
| `.work/docs/integration/` | Vendor/API integration cache (`MANIFEST.txt`) |
| `.work/PROTECTED_SURFACES.json` | Machine-readable high-blast paths for this project |
